...
public class SecurityController {
    ...
    public String toBookingConfirmationForm(Model model) {
        List<String> lines = fileReader.readFile(BOOKING_CONFIRMATION_FILE);
        String confirmationMessage = fileReader.fileContentToString(lines);
        ...
        model.addAttribute("messageContent", confirmationMessage);
